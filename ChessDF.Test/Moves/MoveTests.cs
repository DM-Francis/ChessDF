...
namespace ChessDF.Test.Moves
{
    public class MoveTests
    {
        ...
        public static IEnumerable<object[]> TestMoves()
        {
            ...
            yield return new object[] { "b4a5", position1, new Move(Square.b4, Square.a5, MoveFlags.Capture) };
            ...
            yield return new object[] { "f6e4", position1, new Move(Square.f6, Square.e4, MoveFlags.Capture) };
            yield return new object[] { "b2b1r", position1, new Move(Square.b2, Square.b1, MoveFlags.RookPromotion) };
            yield return new object[] { "b2a1q", position1, new Move(Square.b2, Square.a1, MoveFlags.Capture | MoveFlags.QueenPromotion) };
            ...
            yield return new object[] { "b4c3", position2, new Move(Square.b4, Square.c3, MoveFlags.Capture) };
            yield return new object[] { "c4b3", position3, new Move(Square.c4, Square.b3, MoveFlags.EnPassantCapture) };
        ...
        public void HasCorrectPromotionPiece(MoveFlags flags, Piece? expectedPromotionPiece)
        {
            // Assemble
